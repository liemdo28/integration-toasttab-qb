...
# =============================================================================
# CẤU HÌNH - CHỈNH SỬA FILE config_cl.json TRƯỚC KHI CHẠY
# =============================================================================

CONFIG_FILE = Path(__file__).parent / "config_cl.json"
...
def load_config(config_path: str | None = None) -> dict:
    ...
    if not path.exists():
        ...
        logger.error("Tạo file config_cl.json từ config.example.json")
        sys.exit(1)
...
Ví dụ sử dụng:
  ...
  python toast_to_quickbooks.py --auto               Chạy tự động theo lịch
    ...
    parser.add_argument("--config", type=str, help="Đường dẫn file config JSON (mặc định: config_cl.json)")
